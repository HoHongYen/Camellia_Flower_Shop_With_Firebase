...
<template>
	<!-- Modal Begin -->
	<div v-if="showProductAddModal" :height="auto" :scrollable="true" :adaptive="true">
					...
					<div class="modal-dialog " role="document">
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<button type="button" @click="showProductAddModal = false" class="close rounded-3"
							...
							<div class="modal-body">
								...
								<Form class="container h-100" id="addProduct">
										...
										<div class="col mb-lg-0">
											<div class="card mb-3" style="border-radius: .5rem;">
												<div class="row g-0">
													<div class="col-md-4 gradient-custom text-center text-white"
														...
														<img :src="product.imageUrl"
															class="img-fluid w-75 mt-4 ms-2 me-2" />
													</div>
													...
													<div class="col-md-8">
														<div class="card-body">
															...
															<div class="row pt-1">
																<div class="d-flex flex-row align-items-center mb-3">
																	<Field name="quantity" type="text" class="form-control"
												...
												<div class="row g-0 card-body">
													...
													<div class="row">
														<div class="d-flex flex-row align-items-center mb-2">
															<img src="https://cdn3.iconfinder.com/data/icons/contact-caramel-vol-1/512/LINKS-64.png"
																class="rounded-circle me-2" height="30" />
													...
													<div class="row pt-1">
														<div class="d-flex flex-row align-items-center mb-3">
															<textarea rows="6" v-model="product.description"
																style="width: 100%">
											Nhập mô tả...
											</textarea>
														</div>
							...
							<div class="modal-footer">
								<button type="button" @click="addProduct"
									class="close-btn btn btn-secondary custom-btn-primary">Thêm</button>
								<button type="button" @click="showProductAddModal = false"
...
export default {
	...
	methods: {
		async addProduct() {
			Swal.fire({
				target: document.getElementById('addProduct'),
